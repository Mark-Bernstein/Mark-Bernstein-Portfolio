  ...
  return (
    <div className="aboutText">
      <p>
        ...
        field that he found more intellectually stimulating. After reflecting on
        his future, Mark recognized his strong affinity for learning about and
        utilizing new technology. He pondered,{" "}
        <em>
      ...
      <p>
        ...
        GPA of 3.89. Determined to achieve his career goals, he joined the UCSD
        Coding Bootcamp, successfully completing the program and receiving a
        Certificate of Completion. Equipped with these new skills, Mark was
        eager to apply his knowledge in the real world and continue his learning
      ...
      <p>
        ...
        going to the beach, playing volleyball, pickleball, and spending time
        with friends and family. A San Diego native, he loves traveling to new
